...
aws ecr get-login-password --region $AWS_Region | docker login --username AWS -p $(aws ecr get-login-password --region $AWS_region) $AWS_AccountID.dkr.ecr.$AWS_Region.amazonaws.com
